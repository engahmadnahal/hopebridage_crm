...
Route::post('yatem/information_of_orphan/{id?}', 'YatemController@information_of_orphan')->name('yatem.information_of_orphan'); // new customer
Route::post('yatem/father-info/{id?}', 'YatemController@fatherInfo')->name('yatem.fatherInfo'); // new customer
Route::post('yatem/information_guardian/{id?}', 'YatemController@information_guardian')->name('yatem.information_guardian'); // new customer
Route::post('yatem/family-composition/{id?}', 'YatemController@familyComposition')->name('yatem.familyComposition'); // new customer
Route::post('yatem/family-educational-status/{id?}', 'YatemController@familyEducationalStatus')->name('yatem.familyEducationalStatus'); // new customer
Route::post('yatem/child-psychological-health-condition/{id?}', 'YatemController@childPsychologicalHealthCondition')->name('yatem.childPsychologicalHealthCondition'); // new customer
