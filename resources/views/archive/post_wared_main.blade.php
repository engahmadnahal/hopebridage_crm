            ...
            <div class="accordion accordion-minimal" id="accordion1" role="tablist" aria-multiselectable="true">
                <div class="card">
                    <div class="card-header" role="tab">
                        <h5 class="card-title fw-300"><a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion1" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"><i class="fa fa-search"></i> بحث عن معاملة </a></h5>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(function () {
                ...
                if(window.location.href.indexOf("notReferd") > -1) {

                    var url ='{{url('Post/notReferdData')}}';
                }
                if(window.location.href.indexOf("mainWared") > -1) {
