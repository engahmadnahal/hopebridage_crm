                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <input id="post_date" name="post_date" type="text" class="form-control datepicker" value="{{$Post->post_date}}" data-date-format="yyyy-mm-dd" required data-plugin-options='{"autoclose": true}'> <span class="input-group-addon"><i class="list-icon material-icons">date_range</i></span>
                                            </div>
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            {{--<i class="fa fa-upload font-purple-soft"></i>--}}
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <div class="form-group" style="text-align: center">
                                            <label class="radio-inline"><input type="radio" name="optradio" value="1">وارد</label>
                                            <label class="radio-inline"><input type="radio" name="optradio" value="2">صادر</label>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label font-purple-soft"> رقم المعاملة </label>
                                            <div class="col-md-9">
                                                <input type="text" name="search_post_no" id="search_post_no"  class="form-control" placeholder="بحث برقم المعاملة ">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label font-purple-soft"> عنوان المعاملة</label>
                                            <div class="col-md-9">
                                                <input type="text" name="search_post_name" id="search_post_name" class="form-control" placeholder="بحث بعنوان المعاملة">
                                            </div>
                                        </div>
                                        <button type="submit" id="post_no_btn" class="btn   btn-success   " style="width: 100px;">  بحث  <i class="fa fa-search"></i></button>
