                                            ...
                                            <div class="row">
                                                <div class="col-md-6" style="margin: 10px;">
                                                    ...
                                                    @if(in_array(55,$allowedActions))
                                                        <a href="#action_modal" data-toggle="modal" pull-link="PosJeha/edit" class="btn btn-primary" id="action_btn"> اضافة اجراء <i class="fa fa-plus"> </i> </a>
                                                    @endif
        ...
        <div class="modal fade" id="action_list" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document" style="width: 900px;">
                <div class="modal-content">
                    ...
                    <div class="modal-footer" dir="rtl">
                        <button type="button" id="add_new_action" class="btn   btn-green  " style="width: 100px;"> اضافة اجراء   <i class="fa fa-plus"></i>  </button>
                        <button type="reset"  class="btn   btn-default  " style="width: 100px;" data-dismiss="modal"> اغلاق <i class="fa fa-close"></i></button>
                    </div>
                </div>
            </div>
                    ...
                    {{--"columns": [--}}
                        ...
                        {{--{--}}
                            ...
                            {{--'render': function (data, type, row) {--}}
                                {{--return '<a pull-link="Post/related/'+row['post_id']+'/'+post_id+'" class="btn   btn-icon-only btn-default" title="اضافة كمعاملة مرتبطة" id="add_related">  <i class="fa fa-plus"> </i></a>';--}}
                            {{--}--}}
                        {{--},--}}
                    {{--]--}}
                {{--});--}}
                ...
                {{--oTable = $("#search_related_tb").DataTable({--}}
                    ...
                    {{--"columns": [--}}
                        ...
                        {{--{--}}
                            {{--orderable: false,--}}
                            {{--'render': function (data, type, row) {--}}
                                {{--return '<a pull-link="Post/related/'+row['id']+'/'+post_id+'" class="btn   btn-icon-only btn-default" title="اضافة كمعاملة مرتبطة" id="add_related">  <i class="fa fa-plus"> </i></a>';--}}
                            {{--}--}}
                        {{--},--}}
                    {{--]--}}
                {{--});--}}
