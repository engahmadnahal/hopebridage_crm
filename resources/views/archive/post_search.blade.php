                                ...
                                <div class="row" style="position: relative">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group selectbs-wlbl">
                                            ...
                                            <select data-column="6" class="bs-select form-control searchableList">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group selectbs-wlbl">
                                            ...
                                            <select data-column="4" class="bs-select form-control searchableList">
                                                ...
                                                @foreach($AllMainJeha as $mainjeha)
                                 ...
                                 <span class="col-md-1">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group input-wlbl">
                                            ...
                                            <div class="input-group">
                                                <input id="to_date" name="to_date" type="text" class="form-control datepicker" value="{{$date}}" data-date-format="dd-mm-yyyy" required data-plugin-options='{"autoclose": true}'> <span class="input-group-addon"><i class="list-icon material-icons">date_range</i></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
