...
{{--                    {!! Form::open(['method'=>'post','url'=>url($route) , 'id'=>'add_form','onsubmit'=>'return validateForm()','class'=>'form-horizontal form-row-seperated'])!!}--}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select name="post_in_out" id="post_in_out"  class="form-control" required>
                                        <option value=""> -- بريد داخلي او خارجي -- </option>
                                        @foreach($PostInOut as $p_in_out)
                                            <option value="{{$p_in_out->id}}">{{$p_in_out->name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-9">
                                    <select name="jeha_from" id="jeha_from"  class="form-control" required>
                                        ...
                                        @foreach($JehaAll as $jeha_in)
                                            <option value="{{$jeha_in->id}}">{{$jeha_in->name}}</option>
                                        @endforeach
                                    </select>
                                    <span class="jeha_from" style="color: darkred"></span>
                                </div>
                            </div>
                         </div>
                         <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select name="jeha_to" id="jeha_to"  class="form-control" required>
                                        <option value=""> -- اختر الجهة المستقبلة -- </option>
                                        @foreach($JehaAll as $jeha_in)
                                            <option value="{{$jeha_in->id}}">{{$jeha_in->name}}</option>
                                        @endforeach
                                    </select>
                                    <span class="jeha_to" style="color: darkred"></span>
                                </div>
                            </div>
                         </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="post_no" placeholder="سيتم ادخاله  تلقائيا"  class="form-control" readonly>
                                    <input type="hidden" name="post_replay" value="{{isset($post_replay_id) ? $post_replay_id : ''}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                       <input id="post_date" name="post_date" type="text" class="form-control datepicker" value="{{$date}}" data-date-format="yyyy-mm-dd" required data-plugin-options='{"autoclose": true}'> <span class="input-group-addon"><i class="list-icon material-icons">date_range</i></span>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group" id="div_need_answer" style="display: block">
                                <label class="control-label col-md-3"> الرد خلال </label>
                                <div class="col-md-8">
                                    <select name="answer_days" id="answer_days" class="form-control">
                                        <option value="">الرد خلال</option>
                        ...
                        <div class="col-md-3">
                            {{--<div class="form-group">--}}
                                {{--<div class="input-group">--}}
                                    {{--<input type="text" class="form-control datepicker" value="{{$date}}" data-date-format="yyyy-mm-dd" data-plugin-options='{"autoclose": true}'> <span class="input-group-addon"><i class="list-icon material-icons">date_range</i></span>--}}
                                {{--</div>--}}
                            {{--</div>--}}
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <button type="reset" class="btn btn-red" style="width: 150px;">
                                            الغاء
        ...
        $(document).ready(function () {
            ...
            $('#post_type').change(function(){
               ...
               if((post_type == 1) || (post_type==2))
                   document.getElementById('post_in_out').selectedIndex=2;
               else
                   document.getElementById('post_in_out').selectedIndex=1;
