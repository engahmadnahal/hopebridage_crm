...
@section('content')
    ...
    <div class="row">
        <div class="col-md-9">
            @include('partials.comments', ['subject' => $needs])
        </div>
        <div class="col-md-3">
                ...
                <div class="tablet__head tablet__head__color-brand padding-15-sides">
                    <div class="tablet__head-toolbar">
                        <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-brand nav-tabs-bold tablet-brand-color" role="tablist">
                            ...
                            @if(Entrust::can('invoice-see') && $needs->invoice)
                            <li class="nav-item">
            ...
            @if(Entrust::can('needs-upload-files') && $filesystem_integration)
    ...
    @if(Entrust::can('needs-update-deadline'))
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{route('needs.update.deadline', $needss->external_id)}}" method="POST">
                            @method('PATCH')
                            @csrf
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#add-files').on('click', function () {
                $('#add-files-modal .modal-content').load('/add-documents/{{$needss->external_id}}' + '/needs');
