        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-blue-sharp bold"> خطأ</span>
                </div>
            </div>
                <div class="portlet-body form">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-3"> الادارة </label>
                                <div class="col-md-9">
                                    <select name="jeha" id="jeha"  class="form-control">
                                        @foreach($alljeha as $jeha)
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select name="department" id="department" class="form-control" dir="rtl" >
                                    </select>
                                </div>
                            </div>
                        </div><br>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-3">مدير او قائم باعمال مدير </label>
                                <div class="col-md-9">
                                    <input type="checkbox" name="is_maneger"  class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
            ...
            $(function () {
                ...
                oTable = $("#data_tb").DataTable({
                    ...
                    "columns": [
                        ...
                        {'data': 'department.name', 'name': 'department_id'},
