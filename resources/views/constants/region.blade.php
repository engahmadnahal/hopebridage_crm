                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label col-md-3"> الاسم  </label>
                                    <div class="col-md-9">
                                        <select name="state_id" id="state_id_up"  class="form-control" required>
                                            @foreach($States as $state)
                                                <option value="{{$state->id}}">{{$state->name}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <input type="text" name="values" id="values_up" class="form-control">
            ...
            $(document).on('click', '#edit_btn', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#state_id_up').val(response.items.state_id);
                        $('#values_up').val(response.items.values);
