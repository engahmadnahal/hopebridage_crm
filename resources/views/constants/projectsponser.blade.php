            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="exampleModalLabel">تعديل الجهة</h4>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label col-md-3"> اسم الممول  </label>
                                    <div class="col-md-9">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <input type="text" name="address" id="address_up" class="form-control">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label col-md-3"> الجوال/الهاتف  </label>
                                    <div class="col-md-9">
                                        <input type="text" name="mobile" id="mobile_up" class="form-control">
            ...
            $(document).on('click', '#edit_btn', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#mobile_up').val(response.items.mobile);
                        $('#address_up').val(response.items.address);
