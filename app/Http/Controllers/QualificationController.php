...
class QualificationController extends Controller
{
    ...
    {
        parent::__construct();
        parent::$data['title']='المؤعل العلمي';
        parent::$data["breadcrumb"]="الاعدادات";
        parent::$data["page_name"]='عرض';
        parent::$data["route"]='Qualification';
        parent::$data["perm"]=15;
    }
    ...
    public function store(Request $request){
        if($request->ajax()){
            ...
            $val = Qualification::validateData($request);
    ...
    public function getAll(){
        ...
        return DataTables::of(Qualification::all())
