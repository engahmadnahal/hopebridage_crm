...
class UserOpinionController extends Controller
{
    ...
    {
        parent::__construct();
        parent::$data['title']='ادارة أراء الباحثين';
        parent::$data["breadcrumb"]="الاعدادات";
        parent::$data["page_name"]='رأي باحث';
        parent::$data["route"]='UserOpinion';
        parent::$data["perm"]=15;
    }
    ...
    public function store(Request $request){
        if($request->ajax()){
            ...
            $val = UserOpinion::validateData($request);
    ...
    public function getAll(){
        ...
        return DataTables::of(UserOpinion::all())
