...
class HouseMaterialController extends Controller
{
    public function __construct()
    {
        parent::__construct();
        parent::$data['title']='ادارة  مواد بناء السقف';
        parent::$data["breadcrumb"]="الاعدادات";
        parent::$data["page_name"]='مادة بناء سقف';
        parent::$data["route"]='HouseMaterial';
        parent::$data["perm"]=15;
    }
    ...
    public function store(Request $request){
        if($request->ajax()){
            ...
            $val = HouseMaterial::validateData($request);
    ...
    public function getAll(){
        ...
        return DataTables::of(HouseMaterial::all())
