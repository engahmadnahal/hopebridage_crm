...
class HelpTypeController extends Controller
{
    ...
    {
        parent::__construct();
        parent::$data['title']='ادارة انواع المساعدات';
        parent::$data["breadcrumb"]="الاعدادات";
        parent::$data["page_name"]='نوع المساعدة';
        parent::$data["route"]='HelpType';
        parent::$data["perm"]=15;
    }
    ...
    public function store(Request $request){
        if($request->ajax()){
            ...
            $val = HelpType::validateData($request);
    ...
    public function getAll(){
        ...
        return DataTables::of(HelpType::all())
