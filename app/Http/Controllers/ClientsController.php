...
class ClientsController extends Controller
{
    ...
    public function anyData()
    {
        ...
        return Datatables::of($clients)       
            ->addColumn('namelink', '<a href="{{ route("donors.show",[$external_id]) }}">{{$company_name}}</a>')
            ->addColumn('view', '
                <a href="{{ route(\'donors.show\', $external_id) }}" class="btn btn-link" >'  . __('View') . '</a>')
            ->addColumn('edit', '
                <a href="{{ route(\'donors.edit\', $external_id) }}" class="btn btn-link" >'  . __('Edit') . '</a>')
            ->addColumn('delete', '
                <form action="{{ route(\'donors.destroy\', $external_id) }}" method="POST">
