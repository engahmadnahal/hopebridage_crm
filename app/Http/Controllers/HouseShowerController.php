...
class HouseShowerController extends Controller
{
    public function __construct()
    {
        parent::__construct();
        parent::$data['title']='توفر الحمام';
        parent::$data["breadcrumb"]="الاعدادات";
        parent::$data["page_name"]='توفر حمام';
        parent::$data["route"]='HouseShower';
        parent::$data["perm"]=15;
    }
    ...
    public function store(Request $request){
        if($request->ajax()){
            ...
            $val = HouseShower::validateData($request);
    ...
    public function getAll(){
        ...
        return DataTables::of(HouseShower::all())
