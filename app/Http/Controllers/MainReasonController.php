...
class MainReasonController extends Controller
{
    public function __construct()
    {
        parent::__construct();
        parent::$data['title']='ادارة اسباب  الاحتياج';
        parent::$data["breadcrumb"]="الاعدادات";
        parent::$data["page_name"]='سبب احتياج';
        parent::$data["route"]='MainReason';
        parent::$data["perm"]=15;
    }
    ...
    public function store(Request $request){
        if($request->ajax()){
            ...
            $val =main_reason::validateData($request);
    ...
    public function getAll(){
        ...
        return DataTables::of(main_reason::all())
