...
class SocialStatusController extends Controller
{
    ...
    {
        parent::__construct();
        parent::$data['title']='الحالة الاجتماعية';
        parent::$data["breadcrumb"]="الاعدادات";
        parent::$data["page_name"]='عرض';
        parent::$data["route"]='SocialStatus';
        parent::$data["perm"]=15;
    }
    ...
    public function store(Request $request){
        if($request->ajax()){
            ...
            $val = SocialStatus::validateData($request);
    ...
    public function getAll(){
        ...
        return DataTables::of(SocialStatus::all())
