...
class RegionTypeController extends Controller
{
    ...
    {
        parent::__construct();
        parent::$data['title']='ادارة المناطق السكنية';
        parent::$data["breadcrumb"]="الاعدادات";
        parent::$data["page_name"]='نوع منطقة';
        parent::$data["route"]='RegionType';
        parent::$data["perm"]=15;
    }
    ...
    public function store(Request $request){
        if($request->ajax()){
            ...
            $val = RegionType::validateData($request);
    ...
    public function getAll(){
        ...
        return DataTables::of(RegionType::all())
