...
class FoodGazController extends Controller
{
    public function __construct()
    {
        parent::__construct();
        parent::$data['title']='ادارة وسائل الطهي';
        parent::$data["breadcrumb"]="الاعدادات";
        parent::$data["page_name"]='وسائل طهي';
        parent::$data["route"]='FoodGaz';
        parent::$data["perm"]=15;
    }
    ...
    public function store(Request $request){
        if($request->ajax()){
            ...
            $val = FoodGaz::validateData($request);
    ...
    public function getAll(){
        ...
        return DataTables::of(FoodGaz::all())
