...
class HouseOwnerController extends Controller
{
    ...
    {
        parent::__construct();
        parent::$data['title']='انواع ملكية السكن';
        parent::$data["breadcrumb"]="الاعدادات";
        parent::$data["page_name"]='نوع ملكية سكن';
        parent::$data["route"]='HouseOwner';
        parent::$data["perm"]=15;
    }
    ...
    public function store(Request $request){
        if($request->ajax()){
            ...
            $val = HouseOwner::validateData($request);
    ...
    public function getAll(){
        ...
        return DataTables::of(HouseOwner::all())
