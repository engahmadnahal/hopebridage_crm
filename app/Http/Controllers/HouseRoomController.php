...
class HouseRoomController extends Controller
{
    ...
    {
        parent::__construct();
        parent::$data['title']='ادارة عدد الغرف';
        parent::$data["breadcrumb"]="الاعدادات";
        parent::$data["page_name"]='عدد غرف';
        parent::$data["route"]='HouseRoom';
        parent::$data["perm"]=15;
    }
    ...
    public function store(Request $request){
        if($request->ajax()){
            ...
            $val = HouseRoom::validateData($request);
    ...
    public function getAll(){
        ...
        return DataTables::of(HouseRoom::all())
