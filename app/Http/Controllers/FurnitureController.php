...
class FurnitureController extends Controller
{
    ...
    {
        parent::__construct();
        parent::$data['title']='ادارة الاثاث الثابت';
        parent::$data["breadcrumb"]="الاعدادات";
        parent::$data["page_name"]='نوع اثاث';
        parent::$data["route"]='Furniture';
        parent::$data["perm"]=15;
    }
    ...
    public function store(Request $request){
        if($request->ajax()){
            ...
            $val = Furniture::validateData($request);
    ...
    public function getAll(){
        ...
        return DataTables::of(Furniture::all())
