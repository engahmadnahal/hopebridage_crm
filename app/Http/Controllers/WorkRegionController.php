...
class WorkRegionController extends Controller
{
    ...
    {
        parent::__construct();
        parent::$data['title']='ادارة قطاع العمل';
        parent::$data["breadcrumb"]="الاعدادات";
        parent::$data["page_name"]='قطاع عمل';
        parent::$data["route"]='WorkRegion';
        parent::$data["perm"]=15;
    }
    ...
    public function store(Request $request){
        if($request->ajax()){
            ...
            $val = WorkRegion::validateData($request);
    ...
    public function getAll(){
        ...
        return DataTables::of(WorkRegion::all())
